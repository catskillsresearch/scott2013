...
MODEL_CARDS: tuple[ModelCard, ...] = (
    ModelCard(
        ...
        cite_key="Cur26",
        tool_note=(
            "agent-assisted editing in the Cursor IDE: formalizing Scott's 2013 "
            "*Stochastic λ-Calculi* extended abstract in Agda, "
            "`agda --safe` repair, vision-OCR "
            "transcription, drafting this narrative (`arxiv.md`), and tracking the formalized "
            "inventory. Generated Agda was provisional until it typechecked under `--safe`."
        ),
        reference=(
    ...
    ModelCard(
        ...
        tool_note=(
            ...
            "`Scott2013/GraphModel/`, documentation, and medium proof obligations "
    ...
    ModelCard(
        ...
        tool_note=(
            ...
            "Agda obligations where the proof strategy was already fixed."
        ),
        reference=(
